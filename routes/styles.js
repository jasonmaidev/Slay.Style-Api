...
router.get("/:userId", verifyToken, cache("2 seconds"), getUserStyles)
router.get("/style/:id", verifyToken, cache("2 seconds"), getStyle)
...
router.get("/:userId/:sortByOccasion", verifyToken, cache("2 seconds"), getSuitableStyles)
